...
def find_existing_upload(
    ...
    media_id itself as match_fragment catches a file left behind by
    an earlier run that uploaded successfully but crashed before
    marking drive_uploaded_at in the sheet -- checked BEFORE ever
    downloading or uploading again, so that scenario re-marks the
    sheet instead of creating a genuine duplicate file.
    """
