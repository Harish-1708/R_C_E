...
class _FakePage:
    ...
    def locator(self, _selector):
        # goto_social_listening_for_workspace now clicks the Content
        # sub-tab explicitly after every navigation -- see
        # _ensure_content_tab_active in refunnel_export.py.
        class _L:
            @property
            def first(_s):
                return _s
